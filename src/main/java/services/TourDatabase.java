...
public class TourDatabase {
	...
	private TourDatabase() {
		Tour t1 = new Tour("PHÚ QUỐC (Khuyến mãi mùa hè)", "3 ngày 2 đêm", "Máy bay", "Hằng ngày", 1595000,
		...
		Tour t2 = new Tour("NHA TRANG", "2 ngày 2 đêm", "Tàu hỏa", "Tối thứ 6 và CN", 1540000,
		...
		Tour t3 = new Tour("CÔN ĐẢO", "3 ngày 2 đêm", "Máy bay", "Hằng ngày", 1345000, "");

		Tour t4 = new Tour("PHAN THIẾT-MŨI NÉ", "3 ngày 2 đêm", "Ôtô", "Thứ 7 mỗi tuần", 1250000, "");

		Tour t5 = new Tour("ĐÀ LẠT - ĐỒI MỘNG MƠ", "4 ngày 3 đêm", "Ôtô", "Thứ 7 mỗi tuần", 1320000, "");

		Tour t6 = new Tour("BUÔN MA THUỘT - GIA LAI - KOMTUM", "4 ngày 3 đêm", "Ôtô", "Định kỳ", 1790000, "");
		...
		Customer c1 = new Customer("Nguyen Van Tuan", "12 Nguyen Oanh GV", "nvtuan@yahoo.com", "0908760880");
		addCustomer(c1);

		Booking b1 = new Booking(c1, new GregorianCalendar(2008, 5, 28).getTime(), 3, 1, t1);
		addBooking(b1);
	}
	...
	public void printBooking() {
		...
		for (Booking booking : bookings.values()) {
			...
			System.out.println("Booking Date: " + dateFormat.format(booking.getDepartureDate()));
			System.out.println("Number of People: " + booking.getNoAdults());
			System.out.println("Tour Name: " + booking.getTour().getDescription());
			System.out.println("Tour Duration: " + booking.getTour().getDepartureSchedule());
			System.out.println("Tour Price: " + booking.getTour().getPrice());
			System.out.println("-----------------------------------");
		}
	}
